...
export class ProductRepository {
    ...
    public async createProductWithImage(productCreateRequest: ProductCreateRequest & { product_image: string }): Promise<IProduct> {
        return await ProductModel.create(productCreateRequest);
    }
}
