...
export class ProductService {
    // Create a product with image URL
    public async createProductWithImage(productCreateRequest: ProductCreateRequest, imageUrl: string): Promise<IProduct> {
        const productWithImage = { ...productCreateRequest, product_image: imageUrl };
        return await ProductRepository.createProductWithImage(productWithImage);
    }
}
